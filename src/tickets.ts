 ...
 * 解析车票信息，转换成可读格式
 */
export function parseTicketsInfo(ticketsData: TicketData[], stations: any): TicketInfo[] {
 ...
 * 过滤车票信息
 */
export function filterTicketsInfo(
 ...
 * 提取价格信息
 */
export function extractPrices(ticketData: TicketData): Price[] {
 ...
 * 提取车辆标志信息
 */
export function extractDWFlags(ticketData: TicketData): string[] {
 ...
 * 解析途经站点数据
 */
export function parseRouteStationsData(rawData: Object[]): RouteStationData[] {
 ...
 * 解析途经站点信息
 */
export function parseRouteStationsInfo(
